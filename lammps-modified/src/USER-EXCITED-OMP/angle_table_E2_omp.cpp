...
AngleTableE2OMP::AngleTableE2OMP(class LAMMPS *lmp)
  : AngleTableE2(lmp), ThrOMP(lmp,THR_ANGLE)
{
...
void AngleTableE2OMP::compute(int eflag, int vflag)
{
...
void AngleTableE2OMP::eval(int nfrom, int nto, ThrData * const thr)
{
  int i1,i2,i3,n,type;

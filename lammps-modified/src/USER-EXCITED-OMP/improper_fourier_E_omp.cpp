...
#include <math.h>
#include "improper_fourier_E_omp.h"
#include "atom.h"
#include "comm.h"
#include "neighbor.h"
#include "domain.h"
...
ImproperFourierEOMP::ImproperFourierEOMP(class LAMMPS *lmp)
  : ImproperFourierE(lmp), ThrOMP(lmp,THR_IMPROPER)
{
...
void ImproperFourierEOMP::compute(int eflag, int vflag)
{
...
void ImproperFourierEOMP::eval(int nfrom, int nto, ThrData * const thr)
{
...
template <int EVFLAG, int EFLAG, int NEWTON_BOND>
void ImproperFourierEOMP::add1_thr(const int i1,const int i2,

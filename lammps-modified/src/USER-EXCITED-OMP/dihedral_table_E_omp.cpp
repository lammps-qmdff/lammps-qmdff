...
#include "dihedral_table_E_omp.h"
#include "atom.h"
#include "comm.h"
#include "neighbor.h"
#include "domain.h"
...
DihedralTableEOMP::DihedralTableEOMP(class LAMMPS *lmp)
  : DihedralTableE(lmp), ThrOMP(lmp,THR_DIHEDRAL)
{
...
void DihedralTableEOMP::compute(int eflag, int vflag)
{
...
void DihedralTableEOMP::eval(int nfrom, int nto, ThrData * const thr)
{

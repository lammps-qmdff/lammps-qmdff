...
void Neighbor::init()
{
  ...
  if (force->special_lj[4] == 0.0 && force->special_coul[4] == 0.0)
    special_flag[4] = 0;
  else if (force->special_lj[4] == 1.0 && force->special_coul[4] == 1.0)
    special_flag[4] = 1;
  else special_flag[4] = 2;

  if (force->kspace || force->pair_match("coul/wolf",0) ||
      force->pair_match("coul/dsf",0) || force->pair_match("thole",0))
     special_flag[1] = special_flag[2] = special_flag[3] = special_flag[4] = 2;

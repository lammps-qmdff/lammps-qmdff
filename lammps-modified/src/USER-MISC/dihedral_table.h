...
class DihedralTable : public Dihedral {
 ...
 protected:
  ...
  virtual Table* get_table(int type, int i1, int i2, int i3, int i4);
  std::map<std::string, std::map<std::string, long>> seek_pos_cache;
  std::map<std::string, long> fill_seek_cache(FILE* fp);
  // --------------------------------------------
  // ------------ inline functions --------------
  // --------------------------------------------
  ...
  inline void uf_lookup(int type, double x, double &u, double &f, int i1, int i2, int i3, int i4)
  {
    Table *tb = get_table(type, i1, i2, i3, i4);
  ...
  inline void u_lookup(int type, double x, double &u, int i1, int i2, int i3, int i4)
  {
    Table *tb = get_table(type, i1, i2, i3, i4);
    int N = tablength;

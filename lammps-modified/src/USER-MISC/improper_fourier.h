...
class ImproperFourier : public Improper {
 ...
 protected:
  double *k, *C0, *C1, *C2;
public:
  virtual double getK(int i1, int i2, int i3, int i4, int type) const;
  virtual double getC0(int i1, int i2, int i3, int i4, int type) const;
  virtual double getC1(int i1, int i2, int i3, int i4, int type) const;
  virtual double getC2(int i1, int i2, int i3, int i4, int type) const;
protected:
  int *all;
  virtual void addone(const int &i1,const int &i2,const int &i3,const int &i4,

            ...
            const double &vb3x, const double &vb3y, const double &vb3z)
{
  ...
  c2 = 2.0*s*s-1.0;
  if (eflag) eimproper =  getK(i1,i2,i3,i4,type)*(getC0(i1,i2,i3,i4,type)+getC1(i1,i2,i3,i4,type)*s+getC2(i1,i2,i3,i4,type)*c2);

  // dhax = diffrence between H and A in X direction, etc

  a = getK(i1,i2,i3,i4,type)*(getC1(i1,i2,i3,i4,type)+4.0*getC2(i1,i2,i3,i4,type)*s)*cotphi;
  dhax = hrx-c*arx;
  dhay = hry-c*ary;
  dhaz = hrz-c*arz;
...
double ImproperFourier::getK(int i1, int i2, int i3, int i4, int type) const {
  (void)i1, (void)i2, (void)i3, (void)i4;
  return k[type];
}

double ImproperFourier::getC0(int i1, int i2, int i3, int i4, int type) const {
  (void)i1, (void)i2, (void)i3, (void)i4;
  return C0[type];
}

double ImproperFourier::getC1(int i1, int i2, int i3, int i4, int type) const {
  (void)i1, (void)i2, (void)i3, (void)i4;
  return C1[type];
}

double ImproperFourier::getC2(int i1, int i2, int i3, int i4, int type) const {
  (void)i1, (void)i2, (void)i3, (void)i4;
  return C2[type];
}

...
void DihedralTable::compute(int eflag, int vflag)
{
  ...
  for (n = 0; n < ndihedrallist; n++) {
    ...
    uf_lookup(type, phi, u, m_du_dphi, i1, i2, i3, i4);
...
double DihedralTable::single(int type, int i1, int i2, int i3, int i4)
{
  ...
  double u=0.0;
  u_lookup(type, phi, u, i1, i2, i3, i4); //Calculate the energy, and store it in "u"
...
std::map<std::string, long> DihedralTable::fill_seek_cache(FILE* fp) {
...
DihedralTable::Table *DihedralTable::get_table(int type, int i1, int i2, int i3, int i4) {
